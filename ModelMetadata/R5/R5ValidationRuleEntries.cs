...
internal static class R5ValidationRuleEntries
{
    internal static IReadOnlyDictionary<Type, IReadOnlyList<IFhirValidationRule>> Create() =>
        new Dictionary<Type, IReadOnlyList<IFhirValidationRule>>
        {
            [typeof(Bundle)] =
            [
