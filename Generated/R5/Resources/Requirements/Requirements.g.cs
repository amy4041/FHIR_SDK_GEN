...
/// </summary>
public sealed class Requirements : DomainResource
{
    /// <inheritdoc />
    ...
    /// </summary>
    public IList<FhirCanonical> Actor { get; set; } = new List<FhirCanonical>();

    /// <summary>
    /// The actual statement of requirement, in markdown format.
    /// </summary>
    public IList<RequirementsStatement> Statement { get; set; } = new List<RequirementsStatement>();
}
